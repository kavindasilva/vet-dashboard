...
$petID=5;
$queryInfo=file_get_contents('php://input'); print_r($queryInfo);
$queryInfo="";
//print_r($_GET);
...
//$payload = "{ admissions{id, name, speci} }";
 //$payload = "{ admissions( id:$petID, name:\"$petName\", speci:\"Dog\" ){id, name, speci } }";
 
$payload = "{ admissions( id:$petID, name:\"$petName\", speci:\"Dog\" ){id, name, speci, gender, years,  admittedDate } }";
